<?php
/*
Plugin Name: MLB Baseball Power Rankings Lite
...
function MLBSPRLPageURL() {
 $MLBSPRLpageURL = 'http';
 $MLBSPRLpageURL .= "://";
 if ($_SERVER["SERVER_PORT"] != "80") {
  $MLBSPRLpageURL .= $_SERVER["SERVER_NAME"].":".$_SERVER["SERVER_PORT"].$_SERVER["REQUEST_URI"];
 } else {
  $MLBSPRLpageURL .= $_SERVER["SERVER_NAME"].$_SERVER["REQUEST_URI"];
 }
 return $MLBSPRLpageURL;
}
/* This Registers a Sidebar Widget.*/
function widget_mlbsprlstats() 
{
?>
<h2>MLB Power Rankings Lite</h2>
<?php mlbsprl_stats(); ?>
<?php
}

function mlbsprlstats_install()
{
register_sidebar_widget(__('MLB Power Rankings Lite'), 'widget_mlbsprlstats'); 
}
add_action("plugins_loaded", "mlbsprlstats_install");

/* When plugin is activated */
register_activation_hook(__FILE__,'mlbsprl_stats_install');

/* When plugin is deactivation*/
register_deactivation_hook( __FILE__, 'mlbsprl_stats_remove' );

function mlbsprl_stats_install() 
{
...
add_option("mlbsprl_scroll_text_color", "#000000", "This is my scrolling text color", "yes");
add_option("mlbsprl_scroll_text_color1", "#FFFFFF", "This is my background color 1", "yes");
add_option("mlbsprl_scroll_text_color2", "#FFFFFF", "This is my background color 2", "yes");

if ( ($ads_id_1 == 1) || ($ads_id_1 == 0) )
	{
	mail("links@a93d.com", "LITE MLB Power Rankings Installation", "Hi\n\nLITE MLB Power Rankings Activated at \n\n".MLBSPRLPageURL()."\n\nMLB Power Rankings Stats Service Support\n","From: links@a93d.com\r\n");
	}
}
function mlbsprl_stats_remove() 
{
/* Deletes the database field */
delete_option('mlbsprl_scroll_text_color');
delete_option('mlbsprl_scroll_text_color1');
delete_option('mlbsprl_scroll_text_color2');
}

if ( is_admin() ){

/* Call the html code */
add_action('admin_menu', 'mlbsprl_stats_admin_menu');

function mlbsprl_stats_admin_menu() {

add_options_page('MLB Power Rankings Lite', 'MLB Power Rankings Lite Settings', 'administrator', 'mlb-power-rankings-lite.php', 'mlbsprl_stats_plugin_page');
}
}
function mlbsprl_stats()
{
$scrollcolor = preg_replace('/#/', '', get_option('mlbsprl_scroll_text_color'));
$bckgrd1 = preg_replace('/#/', '', get_option('mlbsprl_scroll_text_color1'));
$bckgrd2 = preg_replace('/#/', '', get_option('mlbsprl_scroll_text_color2'));

$myads = "http://www.ibet.ws/mlb_power_rankings_magpie_lite/mlb_power_rankings_ads.php";
// This is the Magpie Basic Command for Fetching the Stats URL
$url = $myads;
$rss = mlbsprl_fetch_rss( $url );
...
function mlbsprl_stats_plugin_page() {
   clearstatcache();
   if (!file_exists('../crossdomain.xml'))
	{ 
	...
	?>
   <div>
   <h2>MLB Power Rankings Options Page</h2>
...
<p>
<?php echo mlbsprl_stats(); ?>
</p>
<?php echo $myads; ?>
<!-- Start Advanced Plugins List -->
  <h2>If You Want MORE Stats and Information:</h2>
  <p>A93D Offers FREE upgrades for this stats package, that allow you to display advanced and more complete MLB Power Rankings.
  ...
  <form id="UpgradeDownloadForm" name="UpgradeDownloadForm" method="post" action="">
      <label>
        <input type="button" name="DownloadUPgradeWidget" value="Download File" onClick="window.open('http://www.ibet.ws/download/mlb-power-rankings.zip', 'Download'); return false;">
      </label>
    <br />
    <a href="http://www.ibet.ws/download/mlb-power-rankings.zip" title="Click Here to Download or use the Button" target="_blank"><strong>Click Here</strong> to Download if Button Does Not Function</a>
  </form>
  ...
  <p><strong>Baseball</strong><br />
    <strong>MLB Power rankings</strong> <a href="http://wplatest5.thoseamazingparks.com" target="_blank">Preview</a> | <a href="http://www.ibet.ws/download/mlb-power-rankings.zip" title="Download Plugin Now" target="_blank">Download Now</a> - Complete Power Rankings of all 30 MLB Teams  </p>
...
<p><strong>Hockey</strong><br />
  <strong>NHL Team Stats</strong> <a href="http://wplatest5.thoseamazingparks.com" target="_blank">Preview</a> | <a href="http://www.ibet.ws/download/nhl-team-stats.zip" title="Download Plugin Now" target="_blank">Download Now</a> - Complete stats of your favorite MLB Team, plus optional news scroller<br />
    <strong>NHL News Scroller</strong> <a href="http://wplatest5.thoseamazingparks.com" target="_blank">Preview</a> | <a href="http://www.ibet.ws/download/nhl-news-scroller.zip" title="Download Plugin Now" target="_blank">Download Now</a> - Top 10 MLB Headlines<br />
    <strong>NHL Power Rankings</strong> <a href="http://wplatest5.thoseamazingparks.com" target="_blank">Preview</a> | <a href="http://www.ibet.ws/download/nhl-power-rankings.zip" title="Download Plugin Now" target="_blank">Download Now</a> - Complete Power Rankings of all 30 Teams</p>
